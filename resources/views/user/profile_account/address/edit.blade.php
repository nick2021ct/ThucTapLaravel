                ...
                <div class="row">
                  ...
                  <div class="col-xl-6 col-md-6">
                    <div class="wsus__add_address_single">
                      ...
                      <input type="text" placeholder="Home / Office / others" name="address_type" value="{{ $address->address_type }}">
                      @error('address_type')
                          <span style="color: red">{{ $message }}</span>
                      @enderror
                    </div>
                  ...
                  <div class="col-xl-12 col-md-6">
                    <div class="wsus__add_address_single">
                      ...
                      <input type="text" placeholder="specific address" name="specific_address" value="{{ $address->specific_address }}">
