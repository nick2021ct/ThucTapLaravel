                                        ...
                                        <div class="col">
                                            <div class="card-body p-4">
                                              ...
                                              <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div>
                                                    <a href="{{ route('order_history.cancel',$order->id) }}"  class="btn btn-outline-primary" type="button">{{ $order->status !== "canceled" ? "Cancel order" : "Cancel reorder"}}</a>                                                        
                                          ...
                                          <div class="d-flex flex-row justify-content-between align-items-center align-content-center">
                                            <span class="dot"></span>
                                            <hr class="flex-fill  {{ $progress >= 2 ? "track-line" : ""}}"><span class="dot"></span>
                                            <hr class="flex-fill {{ $progress >= 3 ? "track-line" : ""}}"><span class="dot"></span>
                                          ...
                                          <div class="d-flex flex-row justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex flex-column justify-content-center align-items-center"><span>Shipped</span></div>
                                        ...
                                        @foreach ($orderProduct as $product)
                                            <tr>
                                                <td class="images" style="width: 200px;">
                                                    <img src="{{ asset($product->product->thumb_image) }}" alt="" style="width: 80px; height: auto;">
                                                </td>
