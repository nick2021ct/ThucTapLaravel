                                ...
                                <div class="row modal_slider">
                                    <div class="col-xl-12">
                                        <div class="modal_slider_img">
                                            <img src="{{ asset('/') }}/user/images/zoom1.jpg" alt="product" class="img-fluid w-100">
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="modal_slider_img">
                                            <img src="{{ asset('/') }}/user/images/zoom2.jpg" alt="product" class="img-fluid w-100">
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="modal_slider_img">
                                            <img src="{{ asset('/') }}/user/images/zoom3.jpg" alt="product" class="img-fluid w-100">
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="modal_slider_img">
                                            <img src="{{ asset('/') }}/user/images/zoom4.jpg" alt="product" class="img-fluid w-100">
                                        </div>
                                    </div>
                                </div>
                            </div>
