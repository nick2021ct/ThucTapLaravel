              ...
              <div class="">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="form theme-form flat-form" method="POST" action="{{ route('admin.product_variant.store') }}" enctype="multipart/form-data">
                      @csrf
                      ...
                      <input class="form-control" id="input" type="hidden" placeholder="name" name="product_id" value="{{ request()->product }}">
