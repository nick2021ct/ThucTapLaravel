              ...
              <div class="">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="form theme-form flat-form" method="POST" action="{{ route('admin.product_variant.update',$product_variant->id) }}" enctype="multipart/form-data">
                      @csrf
                     @method('PUT')
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input class="form-control" id="input" type="text" placeholder="name" name="name" value="{{ $product_variant->name }}">
                            @error('name')
