          ...
          <div class="container-fluid">
              ...
              <div class="">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="form theme-form flat-form" method="POST" action="{{ route('admin.brand.update',$brand->id) }}" enctype="multipart/form-data">
                      @csrf
                      @method("PUT")
                      <div class="row">
                        <div class="col">
                            <img style="width: 10%" src="{{ asset($brand->logo) }}" alt="">
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input class="form-control" id="pwdre" type="text" placeholder="name" name="name" value="{{ $brand->name }}">
                            @error('name')
                                <span style="color: red">{{ $message }}</span>
                            @enderror
                          </div>
